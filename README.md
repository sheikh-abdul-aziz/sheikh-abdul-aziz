...
| Domain | Technologies & Open-Source Tools |
| :--- | :--- |
| **Design & UI/UX** | Figma, Typography Engineering (FontForge, Fontra), Interface Prototyping |
| **Frontend Engineering** | React, Tailwind CSS, JavaScript, HTML/CSS |
| **Software & Systems** | Android Development, Python, Linux Mint |

---

## 🌱 Research & Ongoing Studies

* **Typeface Engineering:** Designing professional font superfamilies that masterfully balance geometric and grotesque styles.
* **Programming Architectures:** Expanding foundational and structural proficiency in Python and JavaScript.
* **Philosophical Logic:** Engaging in continuous research concerning formal logic, metaphysics, ontology, and classical philosophical frameworks.
...
* **Agency / Portfolio:** [Insert Raydient Studio or Portfolio URL]